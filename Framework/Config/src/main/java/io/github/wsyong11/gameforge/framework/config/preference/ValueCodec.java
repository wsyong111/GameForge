 ...
 * <ul>
 *     <li>编码：由 {@link PreferenceStorage.Editor#setValue(String, Object, Class)} 提供。</li>
 *     <li>解码：由 {@link PreferenceStorage#getValue(String, Class)} 指定的期望类型。</li>
 * </ul>
...
public interface ValueCodec<T> {
	 ...
	 * 通常来自 {@link PreferenceStorage.Editor#setValue(String, Object, Class)} 中提供的类型信息。
	 * 实现可以根据此类型执行适配或特殊处理。
	 * </p>
	 *
     ...
     * <p>
     * {@code type} 由调用者指定，来源于 {@link PreferenceStorage#getValue(String, Class)} 的期望类型。
     ...
     * <p>
     * {@link PreferenceStorage} 会根据此集合匹配合适的编解码器。
     * </p>
     *
