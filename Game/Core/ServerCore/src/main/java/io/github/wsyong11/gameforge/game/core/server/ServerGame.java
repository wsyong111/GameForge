...
//	private CommandPrompt commandPrompt;
	...
	public ServerGame(@NotNull BootstrapContext bootstrapContext) {
		super(bootstrapContext, ResourcePath.of("data"));
...
//		this.commandPrompt = null;
	...
	protected GameContext createGameContext(@NotNull ServiceRegistry serviceRegistry) {
		return new ServerGameContext(this, serviceRegistry);
	}
